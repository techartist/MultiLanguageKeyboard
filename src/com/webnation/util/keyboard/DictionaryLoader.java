...
public class DictionaryLoader implements Runnable {
	...
	/**
	 * Loads dictionary data from a given input stream and use a given latch to signal when the loading is complete. Note that the inputstream will be closed
	 * after the loading.
	 * 
	 ...
	 */
	public DictionaryLoader(InputStream ins, int size, CountDownLatch doneSignal) {
		this.ins = ins;
		this.size = size;
