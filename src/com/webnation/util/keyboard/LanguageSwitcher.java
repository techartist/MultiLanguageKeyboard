...
public class LanguageSwitcher {
	...
	/**
	 * Returns the currently selected input language code, or the display language code if no specific locale was selected for input.
	 */
	...
	/**
	 * Returns the currently selected input locale, or the display locale if no specific locale was selected for input.
	 * 
	 * @return
	 */
	...
	/**
	 * Returns the next input locale in the list. Wraps around to the beginning of the list if we're at the end of the list.
	 * 
	 * @return
	 */
	...
	/**
	 * Returns the previous input locale in the list. Wraps around to the end of the list if we're at the beginning of the list.
	 * 
	 * @return
	 */
