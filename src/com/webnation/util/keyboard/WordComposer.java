...
public class WordComposer {
	...
	/**
	 * Add a new keystroke, with codes[0] containing the pressed key's unicode and the rest of the array containing unicode for adjacent keys, sorted by
	 * reducing probability/proximity.
	 * 
	...
	/**
	 * Swaps the first and second values in the codes array if the primary code is not the first value in the array but the second. This happens when the
	 * preferred key is not the key that the user released the finger on.
	 * 
	...
	/**
	 * Saves the reason why the word is capitalized - whether it was automatic or due to the user hitting shift in the middle of a sentence.
	 * 
