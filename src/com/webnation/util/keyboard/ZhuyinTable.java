...
class ZhuyinTable {
	...
	private static final char[] yiEndingFinals = new char[] { '\u311a', '\u311b', '\u311d', '\u311e', '\u3120', '\u3121', '\u3122', '\u3123', '\u3124',
			'\u3125' };
	private static final char[] wuEndingFinals = new char[] { '\u311a', '\u311b', '\u311e', '\u311f', '\u3122', '\u3123', '\u3124', '\u3125' };
	private static final char[] yuEndingFinals = new char[] { '\u311d', '\u3122', '\u3123', '\u3125' };
	...
	private static final char[] tones = new char[] { DEFAULT_TONE, '\u02d9', '\u02ca', '\u02c7', '\u02cb' };
	...
	static int getSyllablesIndex(String syllables) {
		...
		int finals = getFinals((initials != 0) ? syllables.substring(1) : syllables);
		if (finals < 0) {
			return -1;
		}
	 ...
	 * 
	 * @return the first element as the syllables and second element as the tone; null if the input couldn't be stripped into two parts.
	 */
