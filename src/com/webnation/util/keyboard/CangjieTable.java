...
class CangjieTable {
	...
	// æ—¥æœˆé‡‘æœ¨æ°´ç�«åœŸç«¹æˆˆå��å¤§ä¸­ä¸€å¼“äººå¿ƒæ‰‹å�£å°¸å»¿å±±å¥³ç�?°é›£å�œ
	...
	/**
	 * Returns the primary index calculated by the first and last letter of the given cangjie code.
	 * 
	...
	/**
	 * Returns the secondary index calculated by letters between the first and last letter of the given cangjie code.
	 * 
	 * @param code should not be null.
	 * @return -1 for invalid code.
	 */
