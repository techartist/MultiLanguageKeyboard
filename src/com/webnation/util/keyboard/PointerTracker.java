...
import com.assistek.util.keyboard.LatinKeyboardBaseView.OnKeyboardActionListener;
import com.assistek.util.keyboard.LatinKeyboardBaseView.UIHandler;
...
public class PointerTracker {
	...
	public PointerTracker(int id, UIHandler handler, KeyDetector keyDetector, UIProxy proxy, Resources res, boolean slideKeyHack) {
	...
	private boolean isModifierInternal(int keyIndex) {
		...
		return primaryCode == Keyboard.KEYCODE_SHIFT || primaryCode == Keyboard.KEYCODE_MODE_CHANGE || primaryCode == LatinKeyboardView.KEYCODE_CTRL_LEFT
				|| primaryCode == LatinKeyboardView.KEYCODE_ALT_LEFT || primaryCode == LatinKeyboardView.KEYCODE_FN;
	}
	...
	private void debugLog(String title, int x, int y) {
		...
		Log.d(TAG, String.format("%s%s[%d] %3d,%3d %3d(%s) %s", title, (mKeyAlreadyProcessed ? "-" : " "), mPointerId, x, y, keyIndex, code,
				(isModifier() ? "modifier" : "")));
	}
}
